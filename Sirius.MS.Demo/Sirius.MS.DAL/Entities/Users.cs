...
namespace Sirius.MS.DAL.Entities
{
    public partial class Users
    {
        public Users()
        {
            LoginDtl = new HashSet<LoginDtl>();
            SaleMst = new HashSet<SaleMst>();
        }

        public long Id { get; set; }
        public long? GmidUserGroup { get; set; }
        ...
        public virtual GenMst GmidUserGroupNavigation { get; set; }
        ...
        public virtual ICollection<LoginDtl> LoginDtl { get; set; }
